                ...
                validator.validate().then(function (status) {
                    ...
                    if (status == 'Valid') {
                        ...
                        setTimeout(function () {
                            ...
                            Swal.fire({
                                title: 'Are you sure?',
                                text: "Are you sure you would like to save this user?",
                                icon: 'warning',
                                    ...
                                    $.ajax({
                                        ...
                                        success: function (result) {
                                            if (result.ok) {
                                                ...
                                                Swal.fire({ text: result.message, icon: "success", buttonsStyling: false, confirmButtonText: "Ok", customClass: { confirmButton: "btn btn-primary" } });
                                            }
                                        }
                                    });
                                }
